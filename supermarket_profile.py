...
class SupermarketProfile(tk.Frame):
    # Profile page for supermarket admin – shows user details and delete account option
    def __init__(self, parent, user):
        super().__init__(parent)
        self.user = user          # store the logged‑in user object
        self.parent = parent      # reference to parent widget (for logout)
